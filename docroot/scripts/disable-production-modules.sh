...
/**
 * @file
 * Disables a bunch of UI and Development modules in production instances.
 *
 * Run this script at the root of an existing Drupal installation.
...
$modules_to_disable = array('devel', 'feeds', 'views_ui', 'context_ui', 'ds_ui', 'rules_admin', 'module_filter', 'imagestyleflush','examples', 'action_example', 'ajax_example', 'batch_example', 'block_example', 'cache_example', 'contextual_links_example', 'cron_example', 'dbtng_example', 'email_example', 'entity_example', 'field_example', 'field_permission_example', 'file_example', 'filter_example', 'form_example', 'image_example', 'js_example', 'menu_example', 'node_access_example', 'node_example','nodeapi_example', 'page_example', 'pager_example', 'queue_example','rdf_example', 'render_example', 'simpletest_example', 'tabledrag_example', 'tablesort_example', 'theming_example', 'token_example', 'trigger_example', 'vertical_tabs_example','xmlrpc_example', 
